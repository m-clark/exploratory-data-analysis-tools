...
If the various options of output, or only some of them, appeal to you, they can all be nicely wrapped up in an automatic report. Various settings for each type of output can be set with an additional function (<span class="func" style = "">configure_report</span>) or just passing a list of arguments, including which functions to use, ggplot2 theme, etc.  You can see the report [here](https://m-clark.github.io/), but I also show a screenshot.
