...
```{r summarytools-dfsummary, results='asis', cache.rebuild=T}
...
```{r summarytools-dfsummary-group-by, results='asis', cache.rebuild=T}
library(summarytools)
...
dlookr: pdf report only? bad base R vis
smarteda: vignette code and typos do not inspire confidence
